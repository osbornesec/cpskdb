...
"""
        ...
        self.assertTrue(self.wait_for_qdrant_ready(port=1024, max_wait=60))
...
"""
        ...
        # Wait for service to be ready
        self.assertTrue(self.wait_for_qdrant_ready(port=65535, max_wait=60))
...
"""
        ...
        self.assertTrue(self.wait_for_qdrant_ready(max_wait=120))
...
"""
        ...
        self.assertTrue(self.wait_for_qdrant_ready(max_wait=60))
